...
public class SerializationComponentTest {
    ...
    public void testTrueXml() throws IOException {
        ...
        String fileName = "D:\\Mate.Academy\\Projects\\HomeTask_3_1\\src\\test\\java\\ali_x\\ua\\convertation\\formats\\components\\xml.xml";
    ...
    public void testTrueJson() throws IOException {
        ...
        String fileName = "D:\\Mate.Academy\\Projects\\HomeTask_3_1\\src\\test\\java\\ali_x\\ua\\convertation\\formats\\components\\json.json";
        String expectedResult = new String(Files.readAllBytes(Paths.get(fileName)));
        String actualResult;
