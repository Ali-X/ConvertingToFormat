...
import ali_x.ua.convertation.formats.components.XMLComponent;
import ali_x.ua.convertation.formats.components.XMLGroup;
import ali_x.ua.convertation.formats.print.Print;
import ali_x.ua.convertation.formats.print.XMLPrint;
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        Print print = new XMLPrint(mainGroup);
...
/*        SerializationComponent mainGroup = new JSONGroup();
        ...
        SerializationComponent print = new JSONPrint (mainGroup);*/
    }
